    ...
    fn build_display_list_for_background_if_applicable(&self,
        ...
        match style.get_background().background_clip {
            ...
            background_clip::T::padding_box => {
                bounds.origin.x = bounds.origin.x + border_padding.left - border.left;
                bounds.origin.y = bounds.origin.y + border_padding.top - border.top;
                bounds.size.width = bounds.size.width - (border_padding.left - border.left) - (border_padding.right - border.right);
                bounds.size.height = bounds.size.height - (border_padding.top - border.top) - (border_padding.bottom - border.bottom);
            }
            background_clip::T::content_box => {
                ...
                bounds.size.width = bounds.size.width - border_padding.left - border_padding.right;
                bounds.size.height = bounds.size.height - border_padding.top - border_padding.bottom;
            }
        }
